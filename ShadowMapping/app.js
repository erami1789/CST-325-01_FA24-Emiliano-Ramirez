...
function updateAndRender() {
    ...
    lightCamera.cameraWorldMatrix.makeLookAt(  
        new Vector3(lightPos.x, lightPos.y, lightPos.z),  
        new Vector3(0, 0, 0),  
        new Vector3(0, 1, 0)   
    );
    ...
    gl.uniformMatrix4fv(phongShaderProgram.uniforms.lightVPMatrixUniform, false, lightVPMatrix.transpose().elements);
    var uniforms = phongShaderProgram.uniforms;
    var cameraPosition = camera.getPosition();
    gl.uniform3f(phongShaderProgram.uniforms.directionToLightUniform, directionToLight.x, directionToLight.y, directionToLight.z);
